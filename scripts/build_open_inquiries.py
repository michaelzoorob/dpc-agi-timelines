...
ROWS = [
 ...
 ('Meta/Facebook (behavioural advertising, LQDN complaint)', 'lawfulness of processing for targeted advertising and behavioural analysis',
  '2018-08-31', 'month', 'complaint by La Quadrature du Net (28 May 2018); inquiry commenced Aug 2018 (AR2020 cross-border table); AR2024: final inquiry report July 2024, ongoing at year end; no published decision'),
 ...
 ('Twitter International (breach volume)', 'security of processing (breach volume since May 2018)',
  '2018-11-30', 'month', 'listed open in AR2019 cross-border table; distinct from decided IN-19-1-1'),
 ...
 ('Google Ireland (location data)', 'legal basis and transparency for location data',
  '2020-02-04', 'day', 'DPC press release 4 Feb 2020; no published decision; still open on the 7 Sep 2026 basis date; final decision (EUR 403m) announced 21 Sep 2026, after the basis date'),
 ...
 ('TikTok Technology (China servers, second inquiry)', 'transfers to and storage on servers in China',
  '2025-07-10', 'week', 'DPC press release 10 Jul 2025 (decision to commence notified to TikTok that week); AR2025: on-site inspection Nov 2025'),
